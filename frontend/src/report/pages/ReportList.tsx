                ...
                <tbody>
                  {reports.map((r) => (
                    <tr key={r.id}>
                      ...
                      <td>
                        <span
                          className={`badge rounded-pill px-3 ${CATEGORY_COLORS[r.category] ?? 'text-secondary bg-secondary-subtle'}`}
                        >
                          {r.category}
                        </span>
                      </td>
                      ...
                      <td className="text-end pe-4">
                        <Link to={`/detail/${r.id}`} className="btn btn-sm btn-outline-primary">
